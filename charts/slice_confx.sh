...
do
	...
	sed -i "/nrfIpNg/c\  nrfIpNg: \"192.168.11.$nrfc\"" charts/oai-nrf/values.yaml
	...
	do
		...
		sed -i "/ngapIPadd/c\  ngapIPadd: \"192.168.12.$amfc\"" charts/oai-amf/values.yaml	
		sed -i "/nrfIpv4Addr/c\  nrfIpv4Addr: \"192.168.11.$nrfc\"" charts/oai-amf/values.yaml	
		sed -i "/smfIpv4Addr0/c\  smfIpv4Addr0: \"192.168.13.$supfc1\"" charts/oai-amf/values.yaml
		sed -i "/smfIpv4Addr1/c\  smfIpv4Addr1: \"192.168.13.$supfc2\"" charts/oai-amf/values.yaml
		...
		sed -i "/n4IPadd/c\  n4IPadd: \"192.168.13.$supfc1\"" charts/oai-smf/values.yaml
		sed -i "/amfIpv4Address/c\  amfIpv4Address: \"192.168.12.$amfc\"" charts/oai-smf/values.yaml
		sed -i "/nrfIpv4Address/c\  nrfIpv4Address: \"192.168.11.$nrfc\"" charts/oai-smf/values.yaml
		sed -i "/upfIpv4Address/c\  upfIpv4Address: \"192.168.14.$supfc1\"" charts/oai-smf/values.yaml
		...
		sed -i "/sgwS1uIp/c\  sgwS1uIp: \"192.168.14.$supfc1\"" charts/oai-spgwu-tiny/values.yaml
		sed -i "/sgwSxIp/c\  sgwSxIp: \"192.168.15.$supfc1\" #net2 IP address for UPF" charts/oai-spgwu-tiny/values.yaml
		sed -i "/spgwc0IpAdd/c\  spgwc0IpAdd: \"192.168.13.$supfc1\" #SMF IP address" charts/oai-spgwu-tiny/values.yaml
		sed -i "/nrfIpv4Add/c\  nrfIpv4Add: \"192.168.11.$nrfc\" #NRF IP address" charts/oai-spgwu-tiny/values.yaml
		...
		do
			...
			sed -i "/ngapIPadd/c\  ngapIPadd: \"192.168.16.$gnbsimc\"" charts/oai-gnbsim/values.yaml
			sed -i "/gtpIPadd/c\  gtpIPadd: \"192.168.17.$gnbsimc\"" charts/oai-gnbsim/values.yaml
			sed -i "/gtpulocaladdr/c\  gtpulocaladdr: \"192.168.16.$gnbsimc\"" charts/oai-gnbsim/values.yaml
			sed -i "/ngappeeraddr/c\  ngappeeraddr: \"192.168.12.$amfc\"" charts/oai-gnbsim/values.yaml
...
kubectl exec -it -n oai $dnnpod -- ip route add 12.1.0.0/16 via 192.168.15.10 dev net1
